...
const HIST_PILARES: Record<string, HistoricoPilarMes[]> = {
  'cred-001': [
    { mes: '2025-05', conversao: 55, desconto: 35, recorrencia: 60, cmv: 58 },
    { mes: '2025-06', conversao: 57, desconto: 37, recorrencia: 62, cmv: 59 },
    { mes: '2025-07', conversao: 58, desconto: 38, recorrencia: 63, cmv: 60 },
    { mes: '2025-08', conversao: 59, desconto: 39, recorrencia: 65, cmv: 61 },
    { mes: '2025-09', conversao: 60, desconto: 40, recorrencia: 66, cmv: 61 },
    { mes: '2025-10', conversao: 61, desconto: 42, recorrencia: 68, cmv: 62 },
    { mes: '2025-11', conversao: 62, desconto: 43, recorrencia: 69, cmv: 62 },
    { mes: '2025-12', conversao: 62, desconto: 45, recorrencia: 70, cmv: 62 },
    { mes: '2026-01', conversao: 65, desconto: 47, recorrencia: 73, cmv: 64 },
    { mes: '2026-02', conversao: 68, desconto: 49, recorrencia: 76, cmv: 66 },
    { mes: '2026-03', conversao: 71, desconto: 51, recorrencia: 79, cmv: 67 },
    { mes: '2026-04', conversao: 74, desconto: 53, recorrencia: 81, cmv: 69 },
    { mes: '2026-05', conversao: 78, desconto: 55, recorrencia: 83, cmv: 70 },
  ],
  'cred-002': [
    { mes: '2025-05', conversao: 62, desconto: 58, recorrencia: 72, cmv: 67 },
    { mes: '2025-06', conversao: 60, desconto: 56, recorrencia: 71, cmv: 66 },
    { mes: '2025-07', conversao: 59, desconto: 55, recorrencia: 70, cmv: 65 },
    { mes: '2025-08', conversao: 58, desconto: 54, recorrencia: 69, cmv: 64 },
    { mes: '2025-09', conversao: 57, desconto: 53, recorrencia: 68, cmv: 63 },
    { mes: '2025-10', conversao: 56, desconto: 52, recorrencia: 67, cmv: 63 },
    { mes: '2025-11', conversao: 54, desconto: 50, recorrencia: 67, cmv: 62 },
    { mes: '2025-12', conversao: 52, desconto: 48, recorrencia: 66, cmv: 61 },
    { mes: '2026-01', conversao: 50, desconto: 46, recorrencia: 65, cmv: 60 },
    { mes: '2026-02', conversao: 48, desconto: 44, recorrencia: 64, cmv: 59 },
    { mes: '2026-03', conversao: 46, desconto: 42, recorrencia: 63, cmv: 58 },
    { mes: '2026-04', conversao: 44, desconto: 40, recorrencia: 61, cmv: 57 },
    { mes: '2026-05', conversao: 42, desconto: 38, recorrencia: 60, cmv: 55 },
  ],
  'cred-004': [
    { mes: '2025-05', conversao: 48, desconto: 44, recorrencia: 55, cmv: 50 },
    { mes: '2025-06', conversao: 46, desconto: 42, recorrencia: 53, cmv: 48 },
    { mes: '2025-07', conversao: 44, desconto: 41, recorrencia: 52, cmv: 46 },
    { mes: '2025-08', conversao: 42, desconto: 40, recorrencia: 51, cmv: 45 },
    { mes: '2025-09', conversao: 40, desconto: 38, recorrencia: 49, cmv: 43 },
    { mes: '2025-10', conversao: 38, desconto: 36, recorrencia: 47, cmv: 41 },
    { mes: '2025-11', conversao: 36, desconto: 34, recorrencia: 45, cmv: 40 },
    { mes: '2025-12', conversao: 34, desconto: 33, recorrencia: 43, cmv: 38 },
    { mes: '2026-01', conversao: 32, desconto: 32, recorrencia: 42, cmv: 37 },
    { mes: '2026-02', conversao: 31, desconto: 31, recorrencia: 41, cmv: 36 },
    { mes: '2026-03', conversao: 30, desconto: 31, recorrencia: 41, cmv: 36 },
    { mes: '2026-04', conversao: 29, desconto: 30, recorrencia: 40, cmv: 35 },
    { mes: '2026-05', conversao: 28, desconto: 30, recorrencia: 40, cmv: 35 },
  ],
  'cred-005': [
    { mes: '2025-05', conversao: 53, desconto: 46, recorrencia: 62, cmv: 57 },
    { mes: '2025-06', conversao: 53, desconto: 46, recorrencia: 62, cmv: 57 },
    { mes: '2025-07', conversao: 52, desconto: 47, recorrencia: 63, cmv: 57 },
    { mes: '2025-08', conversao: 52, desconto: 47, recorrencia: 63, cmv: 58 },
    { mes: '2025-09', conversao: 52, desconto: 47, recorrencia: 63, cmv: 58 },
    { mes: '2025-10', conversao: 52, desconto: 48, recorrencia: 63, cmv: 59 },
    { mes: '2025-11', conversao: 52, desconto: 48, recorrencia: 64, cmv: 59 },
    { mes: '2025-12', conversao: 52, desconto: 48, recorrencia: 64, cmv: 59 },
    { mes: '2026-01', conversao: 52, desconto: 48, recorrencia: 64, cmv: 60 },
    { mes: '2026-02', conversao: 52, desconto: 48, recorrencia: 64, cmv: 60 },
    { mes: '2026-03', conversao: 52, desconto: 48, recorrencia: 64, cmv: 60 },
    { mes: '2026-04', conversao: 52, desconto: 48, recorrencia: 64, cmv: 60 },
    { mes: '2026-05', conversao: 52, desconto: 48, recorrencia: 64, cmv: 60 },
  ],
  'cred-006': [
    { mes: '2025-05', conversao: 65, desconto: 60, recorrencia: 73, cmv: 68 },
    { mes: '2025-06', conversao: 66, desconto: 61, recorrencia: 74, cmv: 69 },
    { mes: '2025-07', conversao: 67, desconto: 62, recorrencia: 75, cmv: 70 },
    { mes: '2025-08', conversao: 68, desconto: 63, recorrencia: 76, cmv: 71 },
    { mes: '2025-09', conversao: 69, desconto: 64, recorrencia: 77, cmv: 72 },
    { mes: '2025-10', conversao: 70, desconto: 65, recorrencia: 78, cmv: 73 },
    { mes: '2025-11', conversao: 71, desconto: 66, recorrencia: 79, cmv: 73 },
    { mes: '2025-12', conversao: 71, desconto: 67, recorrencia: 79, cmv: 74 },
    { mes: '2026-01', conversao: 72, desconto: 68, recorrencia: 80, cmv: 74 },
    { mes: '2026-02', conversao: 72, desconto: 68, recorrencia: 80, cmv: 75 },
    { mes: '2026-03', conversao: 73, desconto: 69, recorrencia: 81, cmv: 75 },
    { mes: '2026-04', conversao: 73, desconto: 69, recorrencia: 81, cmv: 76 },
    { mes: '2026-05', conversao: 74, desconto: 70, recorrencia: 82, cmv: 76 },
  ],
  'cred-003': [
    { mes: '2025-05', conversao: 60, desconto: 52, recorrencia: 65, cmv: 60 },
    { mes: '2025-06', conversao: 63, desconto: 55, recorrencia: 68, cmv: 62 },
    { mes: '2025-07', conversao: 66, desconto: 58, recorrencia: 70, cmv: 64 },
    { mes: '2025-08', conversao: 68, desconto: 60, recorrencia: 72, cmv: 66 },
    { mes: '2025-09', conversao: 70, desconto: 62, recorrencia: 74, cmv: 68 },
    { mes: '2025-10', conversao: 72, desconto: 63, recorrencia: 75, cmv: 69 },
    { mes: '2025-11', conversao: 72, desconto: 65, recorrencia: 75, cmv: 71 },
    { mes: '2025-12', conversao: 72, desconto: 65, recorrencia: 75, cmv: 71 },
    { mes: '2026-01', conversao: 78, desconto: 70, recorrencia: 80, cmv: 75 },
    { mes: '2026-02', conversao: 82, desconto: 73, recorrencia: 83, cmv: 78 },
    { mes: '2026-03', conversao: 86, desconto: 76, recorrencia: 86, cmv: 81 },
    { mes: '2026-04', conversao: 90, desconto: 79, recorrencia: 89, cmv: 83 },
    { mes: '2026-05', conversao: 95, desconto: 82, recorrencia: 91, cmv: 85 },
  ],
}
