...
export function DashboardHeader() {
  ...
  return (
    ...
    >
      ...
      <div className="relative px-5 sm:px-6 pt-5 pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 border border-orange-500/30"
              style={{ background: 'linear-gradient(135deg, rgba(255,102,0,0.18) 0%, rgba(255,102,0,0.06) 100%)' }}
            >
              <Eye size={22} className="text-orange-500" />
            </div>
            <div>
              <div className="flex items-center gap-2.5 flex-wrap">
                <h1 className="text-bh-text text-3xl font-black leading-none tracking-tight">Visão Geral</h1>
                <span
              ...
              <p className="text-bh-muted text-sm mt-1.5 leading-snug">
                Acompanhe o desempenho de todas as software house ativas
              </p>
            </div>
          </div>
          <button
            ...
            disabled={loading}
            className="btn-primary flex items-center gap-2 px-4 py-2 text-sm disabled:opacity-60 flex-shrink-0"
            style={{ boxShadow: '0 4px 14px rgba(255,102,0,0.25)' }}
          >
      ...
      {/* Divider */}
      <div className="mx-5 sm:mx-6 h-px" style={{ background: 'rgba(var(--bh-border) / 0.5)' }} />

      {/* Filter section */}
      <div className="relative px-5 sm:px-6 pb-5 pt-4">
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full rounded-lg border px-4 py-3 text-left transition-all hover:border-orange-500/50 hover:shadow-sm"
                style={{
                  background: 'rgb(var(--bh-surface2))',
                  borderColor: showDayPicker ? 'rgba(255,102,0,0.5)' : 'rgba(255,102,0,0.25)',
                }}
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-bh-muted text-[8px] font-semibold tracking-widest uppercase mb-1">DIA / MÊS / ANO</p>
          ...
          <div>
            ...
            <div className="relative">
              <div
                ...
                style={{
                  background: 'rgb(var(--bh-surface2))',
                  borderColor: showCompareDropdown ? 'rgba(255,102,0,0.5)' : 'rgba(255,102,0,0.25)',
                }}
              >
                <button
              ...
              {showCompareDropdown && (
                <div className="absolute z-20 top-full mt-1 w-full rounded-xl border border-orange-500/30 overflow-hidden shadow-2xl"
