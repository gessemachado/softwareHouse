    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between px-8 py-6 border-b border-white/5 shrink-0">
          <div>
            <h2 className="text-white text-xl font-bold">Distribuição Mensal por Categoria</h2>
        ...
        <div className="grid grid-cols-4 gap-4 px-8 py-5 border-b border-white/5 shrink-0">
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            ...
            <p className="text-white text-2xl font-bold">{totalPedidos2026}</p>
          ...
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            ...
            <div className="space-y-1.5 mt-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-white text-xs font-bold">{totalMesmaTrib2026}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-1.5 text-[10px] text-[#888]">
                ...
                <span className="text-white text-xs font-bold">{totalSomItem2026}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-1.5 text-[10px] text-[#888]">
                ...
                <span className="text-white text-xs font-bold">{totalNaoAceit2026}</span>
              </div>
            </div>
            <p className="text-[#444] text-[10px] mt-2">Acumulado 2026</p>
          </div>
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            <p className="text-[#555] text-[9px] font-bold tracking-widest uppercase mb-2">Conversão</p>
