...
export function CardsCarousel() {
  ...
  // ì?ì? Desconto á" delta na taxa de absor√ß√£o ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?
  ...
  // ì?ì? Opera√ß√£o á" delta na convers√£o ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?
  const pedidosVal      = METRICAS['Total de Vendas'][curIdx]
  const pedidosValPrev  = METRICAS['Total de Vendas'][prevIdx]
  const intermedVal     = METRICAS['Total de Intermedia√ß√µes'][curIdx]
  const intermedValPrev = METRICAS['Total de Intermedia√ß√µes'][prevIdx]
  ...
  // ì?ì? D√©bitos á" delta na redu√ß√£o ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?ì?
  ...
  const allSlides: Slide[] = [
    ...
    { id: 'operacao', configId: 'c_gauge',    label: 'Convers√£o',                   delta: convPct     - convPctPrev,     node: <CardGaugeOperacao /> },
  ...
  // Agrupa em p√°ginas de PAGE_SIZE cards
  const pages: Slide[][] = []
  ...
  return (
    <section className="mb-5">
      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-bh-subtle text-[10px] mt-0.5">
            {carouselOrder === 'desc' ? 'Maior ‚Üí Menor varia√ß√£o mensal' : 'Menor ‚Üí Maior varia√ß√£o mensal'}
          </p>
        </div>
        {pages.length > 1 && (
      ...
      {/* Carrossel á" desliza p√°ginas de PAGE_SIZE cards */}
      {/* Usa margin-left em vez de transform para n√£o quebrar position:fixed dos modais */}
      <div
