    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full rounded-2xl border border-white/10 shadow-2xl flex flex-col"
        ...
        <div className="flex items-start justify-between px-8 py-6 border-b border-white/5 shrink-0">
          <div>
            <h2 className="text-white text-xl font-bold">Tributação de Produtos — Histórico</h2>
            <p className="text-[#555] text-xs mt-1">Abr/2025 → Abr/2026 · Tributados vs Isentos</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 px-8 py-5 border-b border-white/5 shrink-0">
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            <p className="text-[#555] text-[9px] font-bold tracking-widest uppercase mb-2">Total Tributado</p>
            <p className="text-orange-400 text-2xl font-bold">{fmtK(totalTrib2026)}</p>
            <p className="text-[#444] text-[10px] mt-1">Acumulado 2026</p>
          </div>
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            <p className="text-[#555] text-[9px] font-bold tracking-widest uppercase mb-2">Total Isento</p>
            <p className="text-emerald-400 text-2xl font-bold">{fmtK(totalIsen2026)}</p>
            <p className="text-[#444] text-[10px] mt-1">Acumulado 2026</p>
          </div>
          <div className="rounded-xl border border-white/5 p-4" style={{ background: 'rgba(255,255,255,0.02)' }}>
            <p className="text-[#555] text-[9px] font-bold tracking-widest uppercase mb-2">% Tributado</p>
            <p className="text-white text-2xl font-bold">{pctTrib2026}%</p>
            <p className="text-[#444] text-[10px] mt-1">Sobre total de vendas</p>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto px-8 py-6">
          <ResponsiveContainer width="100%" height={380}>
            <BarChart data={data} margin={{ top: 10, right: 10, bottom: 5, left: 0 }} barCategoryGap="25%">
              ...
              <YAxis tick={{ fill: '#555', fontSize: 10 }} axisLine={false} tickLine={false} width={44}
