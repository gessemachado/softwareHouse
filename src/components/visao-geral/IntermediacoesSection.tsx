...
export function IntermediacoesSection({ visibleIds }: { visibleIds: string[] }) {
  ...
  const gridClass = n === 3 ? 'lg:grid-cols-3' : n === 2 ? 'lg:grid-cols-2' : ''
  ...
  return (
    <>
      ...
      <div className={`grid grid-cols-1 ${gridClass} gap-5 mb-5`}>

        {/* ── Desconto Disponibilizado ──────────────────────────────────────────── */}
        {visibleIds.includes('desconto') && (
