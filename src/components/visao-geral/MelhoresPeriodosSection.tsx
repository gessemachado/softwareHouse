...
const metrics = [
  ...
  {
    category: 'Qtd de Intermediações',
    icon: '"',
    color: '#2499e4',
    value: 'R$ 92,80',
    change: '+2.1%',
  ...
  return (
    <div className="rounded-lg border border-bh-border/50 bg-bh-bg p-6 mb-5">
      <div className="flex items-center gap-2 mb-5">
        ...
        <h3 className="text-bh-text text-sm font-semibold">Melhores Períodos - Visão Geral</h3>
      </div>
